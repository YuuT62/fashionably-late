...
class ContactRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'first-number'=>['required','numeric','max:5'],
            'middle-number'=>['required','numeric','max:5'],
            'last-number'=>['required','numeric','max:5'],
